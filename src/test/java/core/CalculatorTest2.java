...
public class CalculatorTest2 {
	...
	@BeforeClass 
	public static void BeforeClass() {System.out.println ("Come on, Baby!");}
	@AfterClass
	...
	public void test_01_add_2() {
		...
		assertEquals("Not correct, monkey. Check the signs!",
				Calculator.add(2.0, 2.0), 4.0, 0.09);
	}
	...
	public void test_02_add_3() {
		...
		assertEquals("Not correct, monkey. Check the signs!", 
				Calculator.add(2.0, 2.0, 6.0), 10.0, 0.09);
	}
	...
	public void test_03_add_4() {
		...
		assertEquals("Not correct, monkey. Check the signs!", 
				Calculator.add(5.5, 0.5, 10.3, 2.7), 19.0, 0.09);
	}
